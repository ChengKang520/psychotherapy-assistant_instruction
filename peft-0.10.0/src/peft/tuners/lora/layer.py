...
class LoraLayer(BaseTunerLayer):
    ...
    other_param_names = ("r", "lora_alpha", "scaling", "lora_dropout", "lora_inhibition")

    def __init__(self, base_layer: nn.Module, **kwargs) -> None:
        self.base_layer = base_layer
        self.r = {}
        self.lora_alpha = {}
        self.lora_inhibition = {}
        self.scaling = {}
    ...
    def update_layer(
        self, adapter_name, r, lora_alpha, lora_dropout, lora_inhibition, init_lora_weights, use_rslora, use_dora: bool = False
    ):
        ...
        self.lora_inhibition[adapter_name] = lora_inhibition
        if lora_dropout > 0.0:
...
class Embedding(nn.Module, LoraLayer):
    ...
    def update_layer(self, adapter_name, r, lora_alpha, lora_inhibition, lora_dropout, init_lora_weights, use_rslora, use_dora):
        if r <= 0:
            raise ValueError(f"`r` should be a positive integer value but the value passed is {r}")
